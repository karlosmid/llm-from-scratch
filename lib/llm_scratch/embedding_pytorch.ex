defmodule LlmScratch.EmbeddingPyTorch do
  @moduledoc """
  ...
  with PyTorch's behavior and initialization.
  ...
  ## Example
      ...
      embedding = LlmScratch.EmbeddingPyTorch.new(1000, 256, seed: 42)
      token_ids = Nx.tensor([[1, 2, 3], [4, 5, 6]])
      embeddings = LlmScratch.EmbeddingPyTorch.forward(embedding, token_ids)
  """
  ...
  ## Examples
      ...
      iex> embedding = LlmScratch.EmbeddingPyTorch.new(1000, 256, seed: 42)
  ...
  ## Examples
      ...
      iex> embedding = LlmScratch.EmbeddingPyTorch.new(10, 5, seed: 42)
      iex> weight = LlmScratch.EmbeddingPyTorch.weight(embedding)
      iex> Nx.shape(weight)
      {10, 5}
  """
  ...
  ## Examples
      ...
      iex> embeddings = LlmScratch.EmbeddingPyTorch.forward(embedding, token_ids)
  ...
  ## Examples
      ...
      iex> embedding = LlmScratch.EmbeddingPyTorch.new(10, 5, seed: 42)
      iex> token_ids = Nx.tensor([[1, 2, 3]])
      iex> embeddings = LlmScratch.EmbeddingPyTorch.call(embedding, token_ids)
      iex> Nx.shape(embeddings)
      {1, 3, 5}
  """
  ...
  defimpl Inspect do
    def inspect(embedding, _opts) do
      "LlmScratch.EmbeddingPyTorch(vocab_size=#{embedding.vocab_size}, embedding_dim=#{embedding.embedding_dim}, seed=#{inspect(embedding.seed)})"
    end
  end
end
